...
public class Quinta_SettingsFragmentTest {
    ...
    public void settingsFragmentTest() throws InterruptedException {
        ...
        onView(withId(R.id.modMail)).check(matches(isDisplayed()));
        onView(withId(R.id.modPass)).check(matches(isDisplayed()));
        onView(withId(R.id.deleteAccount)).check(matches(isDisplayed()));

        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.exit), withText("Esci"),
                        childAtPosition(
                                childAtPosition(
