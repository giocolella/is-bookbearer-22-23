...
public class Diciottesima_ModPassActivityTest {
    ...
    @Test
    public void modPassActivityTest() throws InterruptedException {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.modPass), withText("Modifica Password"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.oldP), isDisplayed()));
        editText.check(matches(withId(R.id.oldP)));

        ViewInteraction editText2 = onView(
                allOf(withId(R.id.newPass), isDisplayed()));
        editText2.check(matches(withId(R.id.newPass)));

        ViewInteraction button = onView(
                allOf(withId(R.id.okP), withText("OK"), isDisplayed()));
        button.check(matches(isDisplayed()));

        ViewInteraction button2 = onView(
                allOf(withId(R.id.annullaP), withText("ANNULLA"), isDisplayed()));
        button2.check(matches(isDisplayed()));

        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.okP), withText("OK"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.newPass),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("federico00"), closeSoftKeyboard());
