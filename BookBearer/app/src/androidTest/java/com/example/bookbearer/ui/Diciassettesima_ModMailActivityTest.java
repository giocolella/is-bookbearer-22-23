...
public class Diciassettesima_ModMailActivityTest {
    ...
    @Test
    public void modMailActivityTest() throws InterruptedException {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.oldPassword), isDisplayed()));
        editText.check(matches(withId(R.id.oldPassword)));

        ViewInteraction editText2 = onView(
                allOf(withId(R.id.newMail), isDisplayed()));
        editText2.check(matches(withId(R.id.newMail)));
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.annulla), withText("ANNULLA"), isDisplayed()));
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.oldPassword),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("federico"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.newMail),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("federico1gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.newMail), withText("federico1gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.newMail), withText("federico1gmail.com"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("federico1@gmail.com"));

        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.newMail), withText("federico1@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        //onView(withText("Email modificata")).inRoot(withDecorView(not(decorView))).check(matches(isDisplayed()));
