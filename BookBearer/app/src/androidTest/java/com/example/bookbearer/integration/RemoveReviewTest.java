...
public class RemoveReviewTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        auth.signInWithEmailAndPassword("leonardo@gmail.com","leonardo");
        Thread.sleep(5000);
        FirebaseUser user = auth.getCurrentUser();
        m.put("autore",user.getDisplayName());
        m.put("punteggio","5");
        m.put("descrizione","Questo è un ottimo libro");
        db.collection("Books").document("978-8830102729").collection("Reviews").document(user.getUid()).set(m);
        Thread.sleep(5000);
    }
    ...
    @Test
    public void removeReviewTest() throws InterruptedException {
        ...
        ViewInteraction materialButton3 = onView(allOf(withId(R.id.removeReview), withText("Rimuovi Recensione")));
