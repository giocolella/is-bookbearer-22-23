...
public class Nona_RemoveReviewTest {
    ...
    public void removeReviewTest() throws InterruptedException {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.removeReview), withText("Rimuovi Recensione"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        onView(withText("Recensione cancellata")).inRoot(withDecorView(not(decorView))).check(matches(isDisplayed()));
