...
public class Sedicesima_ListsActivityTestUC_4_92 {
    ...
    @Test
    public void listsActivityTestUC_4_5() throws InterruptedException {
        ...
        onView(withText("Libro già in lista letti")).inRoot(withDecorView(not(decorView))).check(matches(isDisplayed()));
